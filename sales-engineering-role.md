...
- **Anchor credibility in analogous prior work.** Map a near-identical past engagement to the prospect's problem point-by-point so expertise reads as evidence, not a claim (Paradigm ↔ TAG: proprietary scoring engine, multilingual reports, legacy .NET, isolated score module).
